...
namespace QL_ThietBiTinHoc.Models
{
    ...
    partial void DeleteVANTAY(VANTAY instance);
		...
		public ShopQADataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["QUANLYSHOPQUANAOConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnTENNVChanging(string value);
    partial void OnTENNVChanged();
    partial void OnHINHANHVANTAYChanging(string value);
    partial void OnHINHANHVANTAYChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MAVANTAY", DbType="NChar(10) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_HINHANHVANTAY", DbType="NVarChar(300)")]
		public string HINHANHVANTAY
		{
			get
			{
				return this._HINHANHVANTAY;
			}
			set
			{
				if ((this._HINHANHVANTAY != value))
				{
					this.OnHINHANHVANTAYChanging(value);
					this.SendPropertyChanging();
					this._HINHANHVANTAY = value;
					this.SendPropertyChanged("HINHANHVANTAY");
					this.OnHINHANHVANTAYChanged();
				}
			}
		}
